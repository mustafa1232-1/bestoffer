...
android {
    ...
    defaultConfig {
        applicationId = "com.maslaki.company"
            ...
            if (hasReleaseSigning) {
                ...
                if (releaseTaskRequested) {
                    throw GradleException(
                        "Release signing is not configured for app_company. " +
                            "Provide apps/app_company/android/key.properties or root android/key.properties, " +
