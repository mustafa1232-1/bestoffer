...
android {
    namespace = "com.maslaki.delivery"
            ...
            if (hasReleaseSigning) {
                ...
                if (releaseTaskRequested) {
                    throw GradleException(
                        "Release signing is not configured for app_delivery. " +
                            "Provide apps/app_delivery/android/key.properties or root android/key.properties, " +
