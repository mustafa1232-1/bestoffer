            ...
            if (hasReleaseSigning) {
                ...
                if (releaseTaskRequested) {
                    throw GradleException(
                        "Release signing is not configured for app_store. " +
                            "Provide apps/app_store/android/key.properties or root android/key.properties, " +
