            ...
            if (hasReleaseSigning) {
                ...
                if (releaseTaskRequested) {
                    throw GradleException(
                        "Release signing is not configured for app_taxi_captain. " +
                            "Provide apps/app_taxi_captain/android/key.properties or root android/key.properties, " +
