...
void main() {
  testWidgets('user app login boot then logout', (tester) async {
    final scope = 'user_test_login_${DateTime.now().microsecondsSinceEpoch}';
  ...
  testWidgets('user app logs out on role mismatch', (tester) async {
    final scope =
        'user_test_role_mismatch_${DateTime.now().microsecondsSinceEpoch}';
    late _SeededAuthController controller;
