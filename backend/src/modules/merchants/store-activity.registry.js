...
const BUILTIN_ACTIVITY_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    displayNameAr: "الهواتف والتكنولوجيا",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
    ...
    defaultServiceFlags: {},
    defaultBadges: [],
    // Deprecated: merged into `electronics_mobile` (see migration 188). Kept in
    // the registry (inactive) so any legacy value still resolves, but no longer
    // offered at store signup.
    isActive: false,
  },
  {
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Home Furniture",
    displayNameAr: "أثاث منزلي",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Kitchens & Decor",
    displayNameAr: "مطابخ وديكورات",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    displayNameAr: "المكملات الغذائية",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    defaultServiceFlags: {},
    defaultBadges: [],
    // Deprecated: replaced by the "Kids World" hub (kids_essentials). See
    // migration 192. Kept inactive so it is no longer offered at signup.
    isActive: false,
  },
  {
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Snacks & Nuts",
    displayNameAr: "الكرزات",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Mineral Water",
    displayNameAr: "مياه معدنية",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Art Studio",
    displayNameAr: "مرسم لبيع الصور",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Kids Clothing",
    displayNameAr: "ملابس أطفال",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Kids Toys",
    displayNameAr: "ألعاب أطفال",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
  ...
  },
  {
    ...
    baseType: "market",
    displayNameEn: "Kids Essentials",
    displayNameAr: "كل ما يحتاجه الطفل",
    hasDiscoverySubcategories: false,
    supportsChat: false,
    supportsAttachments: false,
    supportsPharmacyWorkflow: false,
