...
export async function updateOwnerMerchant(ownerUserId, dto) {
  const map = {
    ...
    deliveryEtaMinMinutes: "delivery_eta_min_minutes",
    deliveryEtaMaxMinutes: "delivery_eta_max_minutes",
