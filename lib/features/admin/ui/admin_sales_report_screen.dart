...
class AdminSalesReportScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminSalesReportScreen> createState() =>
      _AdminSalesReportScreenState();
}

class _AdminSalesReportScreenState extends ConsumerState<AdminSalesReportScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final raw = await ref.read(adminApiProvider).adminSalesReport(
      ...
      setState(() {
        _loading = false;
        _error = l10n.adminSalesReportLoadFailed;
      });
    }
  }
  ...
  Future<void> _print() async {
    ...
    final headers = <String>[
      l10n.commonMerchant,
      l10n.commonOrders,
      l10n.adminSalesReportTotalSales,
      l10n.adminSalesReportFirstOrder,
      l10n.adminSalesReportLastOrder,
    ];
    ...
    final summary = [
      ...
      '${l10n.adminSalesReportTotalSales}: ${formatIqd(report.summary.totalSales)}',
      '${l10n.commonOrders}: ${report.summary.totalOrders}',
      '${l10n.commonMerchantsCount}: ${report.summary.merchantsCount}',
    ];

    await printAdminFinancialTableReport(
      title: l10n.adminSalesReportTitle,
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => AdminFinancialMerchantDetailsScreen(
          reportType: AdminFinancialMerchantReportType.sales,
        ...
        child: ListView(
          ...
          children: [
            ...
            if (report != null) ...[
              Card(
                child: ListTile(
                  title: Text(l10n.adminSalesReportTotalSales),
                  subtitle: Text(
                    '${formatIqd(report.summary.totalSales)} - '
                    '${l10n.commonOrders}: ${report.summary.totalOrders}',
                  ),
                ),
              ),
            ...
            if (_loading)
              ...
              Padding(
                ...
                child: Center(
                  child: Text(l10n.adminSalesReportNoData),
                ),
              )
            else
              ...report.merchants.map((row) {
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${l10n.commonOrders}: ${row.ordersCount} - '
