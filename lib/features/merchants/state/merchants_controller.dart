...
const List<StoreActivityModel> _fallbackStoreActivities = <StoreActivityModel>[
  ...
  // `phones_technology` was deprecated and merged into `electronics_mobile`
  // (migration 188), so it is intentionally absent from this fallback list.
  StoreActivityModel(
  ...
  // `mother_child` was deprecated and replaced by the Kids World hub
  // (migration 192), so it is intentionally absent from this fallback list.
  StoreActivityModel(
