...
void main() {
  testWidgets('super admin login stays authenticated without auto logout', (
    tester,
  ) async {
    ...
    await tester.enterText(textFields.at(0), '07746515247');
    await tester.enterText(textFields.at(1), '1234');
    await tester.tap(find.byType(ElevatedButton));
    await tester.pump(const Duration(milliseconds: 250));

    expect(authController.state.isSuperAdmin, isTrue);
